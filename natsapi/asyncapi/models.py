...
class SchemaBase(BaseModel):
    ...
    additionalProperties: Union[dict[str, Any], bool] | None = None
...
class Operation(BaseModel):
    ...
    externalDocs: ExternalDocumentation | None = None
    bindings: Union[OperationBindings, Reference, None] = None
    traits: list[Union[OperationTrait, Reference]] | None = None
...
class RequestOperation(Operation):
    replies: list[Union[Message, Reference]] | None = None
...
class Components(BaseModel):
    ...
    messages: dict[str, Union[Message, Reference]] | None = None
    parameters: dict[str, Union[dict[str, Parameter], Reference]] | None = None
    correlationIds: dict[str, Union[CorrelationId, Reference]] | None = None
    operationTraits: dict[str, Union[OperationTrait, Reference]] | None = None
    messageTraits: dict[str, Union[MessageTrait, Reference]] | None = None
    serverBindings: dict[str, Union[ServerBindings, Reference]] | None = None
    channelBindings: dict[str, Union[ChannelBindings, Reference]] | None = None
    operationBindings: dict[str, Union[OperationBindings, Reference]] | None = None
    messageBindings: dict[str, Union[MessageBindings, Reference]] | None = None
...
class AsyncAPI(BaseModel):
    ...
    channels: dict[str, Union[ChannelItem, Reference]] | None = None
